          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-200/80 dark:bg-slate-700/80 hover:bg-slate-300 dark:hover:bg-slate-600 rounded-lg transition text-muted text-xs"
              >
              ...
              <button
                onClick={toggleDark}
                className="flex items-center gap-1 px-2.5 py-1.5 bg-slate-200/80 dark:bg-slate-700/80 hover:bg-slate-300 dark:hover:bg-slate-600 rounded-lg transition text-xs"
                aria-label="다크모드 토글"
              >
                {dark ? (
                  <>
                    ...
                    <span className="hidden sm:inline text-muted">라이트</span>
                  </>
                ) : (
                  <>
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <span className="hidden sm:inline text-muted">다크</span>
                  </>
                )}
              </button>
